...
function validarNombre() {
  if (!inputNombre.value) {
    ...
    spanNombre.style.display = "block"
    spanNombre.innerHTML = 'Formato de nombre no admitido';
    inputNombre.classList.add('input-nombre')
  } else {
...
/* Alert Thank you Notificación */
formulario.onsubmit = function (e) {
    e.preventDefault();
    this.checkValidity() ? (alert('¡Genial! Tu inscripción se ha registrado correctamente.'))
        : (
            validarNombre(),
            validarEmail(),
            validarpassword(),
